...
export default function WelcomeBack() {
    return (
        <MainLayout>
            <Container
                className="welcome-back flex-row space-around"
                maxWidth={"lg"}
            >
                <Benefits />
                <Signin />
    ...
    return (
        <Container className="benefits" maxWidth="sm">
            <p className="h2 medium32">
                Enjoy all big benefits from Elma that you can’t find in other
                product again
            </p>
            <Grid
                container
                    ...
                    <Grid key={index} xs={6}>
                        <Card className="benefits-item border-1-solid non-box-shadow">
                            <Stack spacing={1.5}>
                                ...
                                <p className="black-title h6 regular">
                                    {item.title}
                                </p>
        ...
        <Stack width={540} spacing={3}>
            ...
            <Stack spacing={3}>
                ...
                <tr className="flex-space-between">
                    ...
                    <Button
                        variant="outlined"
                        className="button-outlined register-btn"
                    >
